...
Feature: FEATURE ATP_GESSOH_WOSOHALL
    ...
    Scenario: Scenario Outline name: Creation Object Orders
        ...
        When the user writes "param:USV_SOSITE" to the selected text field
        ...
        When the user writes "param:USV_SOCUST" to the selected text field
        ...
        When the user writes "param:USV_SODLVSITE" to the selected text field
