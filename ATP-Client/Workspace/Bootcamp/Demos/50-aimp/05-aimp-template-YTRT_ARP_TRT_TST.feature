...
Feature: 05-aimp-template-YTRT_ARP_TRT_TST
    ...
    Scenario Outline: Execute AIMP - step 2
        ...
        Examples:
            | Parameter       | Value             |
            | "Script"        | "YTRT_ARP_TRT_TST"|
            | "Input param 1" | "Olivier"         |
            | "Input param 2" | "Mantel"          |
            #| "Input param 3" | ""                |
            #| "Input param 4" | ""                |
            #| "Input param 5" | ""                |
    ...
    Then the user extracts the value from the selected log panel line starting at 32 for 200 characters and stores it in key "ENV_OUT_01"
    #And the user waits 10 seconds

    #This step definition will allways select the 1st occurent of the text searched
    When the user selects the log panel line containing text "OUT_02"
    Then the user extracts the value from the selected log panel line starting at 32 for 200 characters and stores it in key "ENV_OUT_02"
    And the user waits 10 seconds
